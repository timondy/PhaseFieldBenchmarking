...
!      integer :: gid(nfaces+1+nchild,maxblocks_tr)
     ...
     &        user_attr_5_value
      ...
      double precision :: xxmin, xxmax, yymin, yymax, zzmin, zzmax
...
!       amr_redist_blks do not move the guardcells.
     ...
     &                       l_move_solution)
      ...
      write(*,*) 'mpi_amr_checkpoint_re_hdf5: after amr_morton_order : pe lnb ',mype,lnblocks
...
!CEG added call to set_domain_limits_re_hdf5 (below)
!      print*, 'Assuming right initial domain - mpi_source/mpi_amr_checkpoint_re_hdf5.F90 to blame if not'
...
subroutine set_domain_limits_re_hdf5
...
end subroutine set_domain_limits_re_hdf5

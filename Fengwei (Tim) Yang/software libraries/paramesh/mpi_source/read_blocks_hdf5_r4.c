...
void var_to_block_pointer_r4(float unk[], int iorder[], int nvar, int nx, int ny, int nz,
			  int kstart, int kend,
			  int jstart, int jend,
			  int istart, int iend,
  ...
  *lnblocks = 0;
  ...
  for (lb = 0; lb < *lnblocks; lb++) {
    ...
    if (*nvar_chk_cc > 0) {
      ...
      var_to_block_pointer_r4(unk, iorder, *nvar, *nx, *ny, *nz,
			   kstart, kend,
			   jstart, jend,
			   istart, iend,
			   checkp_on_cc, 0, 0, lb,
    ...
    if (*nvar_chk_fc > 0) {
      ...
      var_to_block_pointer_r4(facevarx, iorder, *nbndvar, *nx+1, *ny, *nz,
			   kstart, kend,
			   jstart, jend,
			   istart, iend+1,
			   checkp_on_fc, 2, 0, lb,
    ...
    /* facevary data */
      ...
      var_to_block_pointer_r4(facevary, iorder, *nbndvar, *nx, *ny+k2d, *nz,
			   kstart, kend,
			   jstart, jend+k2d,
			   istart, iend,
			   checkp_on_fc, 2, 1, lb,
    ...
    /* facevarz data */
      ...
      var_to_block_pointer_r4(facevarz, iorder, *nbndvar, *nx, *ny, *nz+k3d,
			   kstart, kend+k3d,
			   jstart, jend,
			   istart, iend,
			   checkp_on_fc, 2, 2, lb,
    ...
    if (*nvar_chk_ec > 0) {
      ...
      var_to_block_pointer_r4(unk_e_x, iorder, *nbndvare, *nx, *ny+k2d, *nz+k3d,
			   kstart, kend+k3d,
			   jstart, jend+k2d,
			   istart, iend,
			   checkp_on_ec, 2, 0, lb,
    ...
    /* unk_e_y data */
      ...
      var_to_block_pointer_r4(unk_e_y, iorder, *nbndvare, *nx+1, *ny, *nz+k3d,
			   kstart, kend+k3d,
			   jstart, jend,
			   istart, iend+1,
			   checkp_on_ec, 2, 1, lb,
    ...
    /* unk_e_z data */
      ...
      var_to_block_pointer_r4(unk_e_z, iorder, *nbndvare, *nx+1, *ny+k2d, *nz,
			   kstart, kend,
			   jstart, jend+k2d,
			   istart, iend+1,
			   checkp_on_ec, 2, 2, lb,
    ...
    if (*nvar_chk_nc > 0) {
      ...
      var_to_block_pointer_r4(unk_n, iorder, *nbndvarc, *nx+1, *ny+k2d, *nz+k3d,
			   kstart, kend+k3d,
			   jstart, jend+k2d,
			   istart, iend+1,
			   checkp_on_nc, 0, 0, lb,

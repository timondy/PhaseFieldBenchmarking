       ...
       do k=klbnd,kubnd
         do j=jlbnd,jubnd
           do i=ilbnd,iubnd+ione
             do ivar=1,nbndvar
               facevarx(ivar,i,j,k,l)=0.                       !<<<< USER EDIT
             enddo
           enddo
         enddo
       enddo
       ...
       do k=klbnd,kubnd
         do i=ilbnd,iubnd
           do j=jlbnd,jubnd+jone
             do ivar=1,nbndvar
               facevary(ivar,i,j,k,l)=0.                       !<<<< USER EDIT
             enddo
           enddo
         enddo
       enddo
       ...
       do j=jlbnd,jubnd
         do i=ilbnd,iubnd
           do k=klbnd,kubnd+kone
             do ivar=1,nbndvar
               facevarz(ivar,i,j,k,l)=0.                       !<<<< USER EDIT
             enddo
           enddo
         enddo
       enddo

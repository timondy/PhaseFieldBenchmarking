/* src/H5config_fortran.h.  Generated from H5config_fortran.h.in by configure.  */
...
#define H5_FORTRAN_PACKAGE_BUGREPORT "help@hdfgroup.org"

/* Define to the full name of this package. */
#define H5_FORTRAN_PACKAGE_NAME "HDF5 Fortran"

/* Define to the full name and version of this package. */
#define H5_FORTRAN_PACKAGE_STRING "HDF5 Fortran 1.6.10"

/* Define to the one symbol short name of this package. */
#define H5_FORTRAN_PACKAGE_TARNAME "hdf5-fortran"

/* Define to the version of this package. */
#define H5_FORTRAN_PACKAGE_VERSION "1.6.10"

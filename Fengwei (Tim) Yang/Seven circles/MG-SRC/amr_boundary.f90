...
!!dirichlet                                unk1(1,i,j,k,idest) = - unk1(1,i,2*nguard+1-j,k,idest) 
!!dirichlet                                unk1(2,i,j,k,idest) = - unk1(2,i,2*nguard+1-j,k,idest) 
!!dirichlet                                unk1(3,i,j,k,idest) = - unk1(3,i,2*nguard+1-j,k,idest) 
!!dirichlet                                unk1(4,i,j,k,idest) = - unk1(4,i,2*nguard+1-j,k,idest) 
!!dirichlet                                unk1(5,i,j,k,idest) = - unk1(5,i,2*nguard+1-j,k,idest) 
!!dirichlet                                unk1(6,i,j,k,idest) = - unk1(6,i,2*nguard+1-j,k,idest) 
!!dirichlet                                unk1(7,i,j,k,idest) = - unk1(7,i,2*nguard+1-j,k,idest) 
                             else if (surrblks(1,2,1,2)>-20) then
                                unk1(:,i,j,k,idest) = unk1(:,2*nguard+1-i,j,k,idest) 

!!dirichlet                                unk1(1,i,j,k,idest) = - unk1(1,2*nguard+1-i,j,k,idest) 
!!dirichlet                                unk1(2,i,j,k,idest) = - unk1(2,2*nguard+1-i,j,k,idest) 
!!dirichlet                                unk1(3,i,j,k,idest) = - unk1(3,2*nguard+1-i,j,k,idest) 
!!dirichlet                                unk1(4,i,j,k,idest) = - unk1(4,2*nguard+1-i,j,k,idest) 
!!dirichlet                                unk1(5,i,j,k,idest) = - unk1(5,2*nguard+1-i,j,k,idest) 
!!dirichlet                                unk1(6,i,j,k,idest) = - unk1(6,2*nguard+1-i,j,k,idest) 
!!dirichlet                                unk1(7,i,j,k,idest) = - unk1(7,2*nguard+1-i,j,k,idest) 
                             else
                                unk1(:,i,j,k,idest) = unk1(:,2*nguard+1-i,2*nguard+1-j,k,idest) 

!!dirichlet                                unk1(1,i,j,k,idest) = - unk1(1,2*nguard+1-i,2*nguard+1-j,k,idest) 
!!dirichlet                                unk1(2,i,j,k,idest) = - unk1(2,2*nguard+1-i,2*nguard+1-j,k,idest) 
!!dirichlet                                unk1(3,i,j,k,idest) = - unk1(3,2*nguard+1-i,2*nguard+1-j,k,idest) 
!!dirichlet                                unk1(4,i,j,k,idest) = - unk1(4,2*nguard+1-i,2*nguard+1-j,k,idest) 
!!dirichlet                                unk1(5,i,j,k,idest) = - unk1(5,2*nguard+1-i,2*nguard+1-j,k,idest) 
!!dirichlet                                unk1(6,i,j,k,idest) = - unk1(6,2*nguard+1-i,2*nguard+1-j,k,idest) 
!!dirichlet                                unk1(7,i,j,k,idest) = - unk1(7,2*nguard+1-i,2*nguard+1-j,k,idest) 
                             endif
...
!!dirichlet                                unk1(1,i,j,k,idest) = - unk1(1,i,2*nguard+2*nyb+1-j,k,idest)
!!dirichlet                                unk1(2,i,j,k,idest) = - unk1(2,i,2*nguard+2*nyb+1-j,k,idest)
!!dirichlet                                unk1(3,i,j,k,idest) = - unk1(3,i,2*nguard+2*nyb+1-j,k,idest)
!!dirichlet                                unk1(4,i,j,k,idest) = - unk1(4,i,2*nguard+2*nyb+1-j,k,idest)
!!dirichlet                                unk1(5,i,j,k,idest) = - unk1(5,i,2*nguard+2*nyb+1-j,k,idest)
!!dirichlet                                unk1(6,i,j,k,idest) = - unk1(6,i,2*nguard+2*nyb+1-j,k,idest)
!!dirichlet                                unk1(7,i,j,k,idest) = - unk1(7,i,2*nguard+2*nyb+1-j,k,idest)
                             else if (surrblks(1,2,3,2)>-20) then
                                unk1(:,i,j,k,idest) = unk1(:,2*nguard+1-i,j,k,idest)
...
!!dirichlet                                unk1(1,i,j,k,idest) = - unk1(1,2*nguard+1-i,2*nguard+2*nyb+1-j,k,idest)
!!dirichlet                                unk1(2,i,j,k,idest) = - unk1(2,2*nguard+1-i,2*nguard+2*nyb+1-j,k,idest)
!!dirichlet                                unk1(3,i,j,k,idest) = - unk1(3,2*nguard+1-i,2*nguard+2*nyb+1-j,k,idest)
!!dirichlet                                unk1(4,i,j,k,idest) = - unk1(4,2*nguard+1-i,2*nguard+2*nyb+1-j,k,idest)
!!dirichlet                                unk1(5,i,j,k,idest) = - unk1(5,2*nguard+1-i,2*nguard+2*nyb+1-j,k,idest)
!!dirichlet                                unk1(6,i,j,k,idest) = - unk1(6,2*nguard+1-i,2*nguard+2*nyb+1-j,k,idest)
!!dirichlet                                unk1(7,i,j,k,idest) = - unk1(7,2*nguard+1-i,2*nguard+2*nyb+1-j,k,idest)
                             endif
                       case(11)
!1 e3
...
!!dirichlet                                unk1(1,i,j,k,idest) = - unk1(1,2*nguard+2*nxb+1-i,j,k,idest) 
!!dirichlet                                unk1(2,i,j,k,idest) = - unk1(2,2*nguard+2*nxb+1-i,j,k,idest) 
!!dirichlet                                unk1(3,i,j,k,idest) = - unk1(3,2*nguard+2*nxb+1-i,j,k,idest) 
!!dirichlet                                unk1(4,i,j,k,idest) = - unk1(4,2*nguard+2*nxb+1-i,j,k,idest) 
!!dirichlet                                unk1(5,i,j,k,idest) = - unk1(5,2*nguard+2*nxb+1-i,j,k,idest) 
!!dirichlet                                unk1(6,i,j,k,idest) = - unk1(6,2*nguard+2*nxb+1-i,j,k,idest) 
!!dirichlet                                unk1(7,i,j,k,idest) = - unk1(7,2*nguard+2*nxb+1-i,j,k,idest) 
                             else
                                unk1(:,i,j,k,idest) = unk1(:,2*nguard+2*nxb+1-i,2*nguard+1-j,k,idest) 

!!dirichlet                                unk1(1,i,j,k,idest) = - unk1(1,2*nguard+2*nxb+1-i,2*nguard+1-j,k,idest) 
!!dirichlet                                unk1(2,i,j,k,idest) = - unk1(2,2*nguard+2*nxb+1-i,2*nguard+1-j,k,idest) 
!!dirichlet                                unk1(3,i,j,k,idest) = - unk1(3,2*nguard+2*nxb+1-i,2*nguard+1-j,k,idest) 
!!dirichlet                                unk1(4,i,j,k,idest) = - unk1(4,2*nguard+2*nxb+1-i,2*nguard+1-j,k,idest) 
!!dirichlet                                unk1(5,i,j,k,idest) = - unk1(5,2*nguard+2*nxb+1-i,2*nguard+1-j,k,idest) 
!!dirichlet                                unk1(6,i,j,k,idest) = - unk1(6,2*nguard+2*nxb+1-i,2*nguard+1-j,k,idest) 
!!dirichlet                                unk1(7,i,j,k,idest) = - unk1(7,2*nguard+2*nxb+1-i,2*nguard+1-j,k,idest) 
                             endif
                        case(7)
! 3 a3
                             if (surrblks(1,2,1,2)>-20 .and. surrblks(1,2,2,3)>-20) then
...
!!dirichlet                                unk1(1,i,j,k,idest) = - unk1(1,2*nguard+2*nxb+1-i,2*nguard+2*nyb+1-j,k,idest)
!!dirichlet                                unk1(2,i,j,k,idest) = - unk1(2,2*nguard+2*nxb+1-i,2*nguard+2*nyb+1-j,k,idest)
!!dirichlet                                unk1(3,i,j,k,idest) = - unk1(3,2*nguard+2*nxb+1-i,2*nguard+2*nyb+1-j,k,idest)
!!dirichlet                                unk1(4,i,j,k,idest) = - unk1(4,2*nguard+2*nxb+1-i,2*nguard+2*nyb+1-j,k,idest)
!!dirichlet                                unk1(5,i,j,k,idest) = - unk1(5,2*nguard+2*nxb+1-i,2*nguard+2*nyb+1-j,k,idest)
!!dirichlet                                unk1(6,i,j,k,idest) = - unk1(6,2*nguard+2*nxb+1-i,2*nguard+2*nyb+1-j,k,idest)
!!dirichlet                                unk1(7,i,j,k,idest) = - unk1(7,2*nguard+2*nxb+1-i,2*nguard+2*nyb+1-j,k,idest)
                             endif

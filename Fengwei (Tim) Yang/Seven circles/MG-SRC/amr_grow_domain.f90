...
!        print *, pid, ' block ', lb, parent(1,lb),parent(2,lb)
        ...
        if (1.lt.2) then
!!new           write(6,'(I3,X,I3,X,I3,X,I3,X,I3,X,I3,X,I3,X,I3)')pid, lb,neigh(1,1,lb),neigh(1,2,lb),neigh(1,3,lb),neigh(1,4,lb),neigh(1,5,lb),neigh(1,6,lb)
!!new           write(6,'(I3,X,I3,X,I3,X,I3,X,I3,X,I3,X,I3,X,I3)')pid, lb,neigh(2,1,lb),neigh(2,2,lb),neigh(2,3,lb),neigh(2,4,lb),neigh(2,5,lb),neigh(2,6,lb)
...
!!new                 print*,pid, child(1,i,lb),neigh(1,1,child(1,i,lb)),neigh(1,2,child(1,i,lb)),neigh(1,3,child(1,i,lb)),neigh(1,4,child(1,i,lb))
!!new                 print*,pid, child(2,i,lb),neigh(2,1,child(1,i,lb)),neigh(2,2,child(1,i,lb)),neigh(2,3,child(1,i,lb)),neigh(2,4,child(1,i,lb))
...
subroutine graphviz_output(pid, noprocs, step)
  ...
  if (ndim.eq.3) then
     do lb=1, lnblocks
        if (lrefine(lb).eq.mg_min_lvl) then
!!new           write(62,'(I3,X,I3,X,I3,X,I3,X,I3,X,I3)')neigh(1,1,lb),neigh(1,2,lb),neigh(1,3,lb),neigh(1,4,lb),neigh(1,5,lb),neigh(1,6,lb)
!!new           write(62,'(I3,X,I3,X,I3,X,I3,X,I3,X,I3)')neigh(2,1,lb),neigh(2,2,lb),neigh(2,3,lb),neigh(2,4,lb),neigh(2,5,lb),neigh(2,6,lb)
        endif
     end do
  else
     do lb=1, lnblocks
        if (lrefine(lb).eq.mg_min_lvl) then
!!new           write(62,'(I3,X,I3,X,I3,X,I3,X,I3,X,I3)')neigh(1,1,lb),neigh(1,2,lb),neigh(1,3,lb),neigh(1,4,lb),-23,-23
!!new           write(62,'(I3,X,I3,X,I3,X,I3,X,I3,X,I3)')neigh(2,1,lb),neigh(2,2,lb),neigh(2,3,lb),neigh(2,4,lb),-23,-23
        endif
     end do
  endif
  close(62)
